...
| `CofoldError("conflict")` | understood and refused | 1 |
| anything else | | 1 |

Scripts switch on these, so they are part of your surface. Add your own by extending `CofoldError` with one of the kinds.
