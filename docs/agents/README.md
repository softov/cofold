...
| Package | What |
| --- | --- |
| [`@facio/agents`](../../packages/agents) | Contracts, JSON Schema validation, `createTool`, `createAgent`, `run`, `resume`, capabilities, skills and deferred tools, the step log, in-memory store, fake model. |
