---
title: CLI-02 - papo slash commands: what `/` offers beyond the settings
domain: cli
status: built
priority: high
created: 2026-09-16
...
requires:
  ...
  - plans/tools/01-standard-tools/plan.md
---
...
| --- | --- | --- |
| [01 - usage on turns, export, listSkills, shipped skills](task-01-usage-turns-export-listskills-shipped.md) | done | - |
| [02 - the overlay and the commands](task-02-overlay-commands.md) | done | 01 |
