...
- `pnpm --filter @facio/papo typecheck`; `pnpm vitest run --project @facio/papo`; `pnpm check`.
...
- Evidence: `pnpm --filter @facio/papo typecheck` clean; `pnpm vitest run --project @facio/papo` 129 tests green; `pnpm check` 67 files, 773 tests green (2026-09-16).
