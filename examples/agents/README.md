...
```bash
pnpm --filter cofold-examples-agents smoke
```
...
```bash
pnpm --filter cofold-examples-agents smoke -- --effort xhigh
```
...
```bash
pnpm --filter cofold-examples-agents standalone
```
...
```bash
pnpm --filter cofold-examples-agents lmstudio-tools
```
...
```bash
pnpm --filter cofold-examples-agents ask-user            # prompts in a terminal
printf "Rust\nmy-app\n" | pnpm --filter cofold-examples-agents ask-user   # one answer per line
```
...
```bash
pnpm --filter cofold-examples-agents steer
```
