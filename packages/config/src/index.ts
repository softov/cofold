...
import { ConfigurationError, type CommandContext, type OptionSpec } from "@cofold/commands";

export type { ConfigLayerKind, ConfigLayer, ConfigOptions, ResolvedConfig, ConfigProviderOptions } from "./types/config.js";

/**
 * @cofold/config - finding the configuration, not parsing it.
 *
 ...
 * seam `@cofold/remote` uses for a manifest: the shape is ours, the syntax is
