import type { ApprovalPayload, InputPayload, Message, PendingRequest, RunRecord, StopReason, ToolCallPart } from '@cofold/agents';
import { INTERRUPTED, ZERO_USAGE, textOf } from '@cofold/agents';
