import type { Limits, ModelParams, RulesOptions } from '@facio/agents';
...
/**
 * Rule lists for `rules()` (`@facio/agents`, decision 117), as the configuration and a session's settings hold them
