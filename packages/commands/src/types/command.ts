...
import type { StandardSchema } from "@cofold/sdk";
 ...
 * `@cofold/remote` adds `http`. So the binding is checked at the declaration
 ...
 *
 * Widened by whichever surface owns the key - `@cofold/remote` adds `http` -
